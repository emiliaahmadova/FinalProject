...
CREATE TABLE `sales` (
  ...
  `UserId` int NOT NULL,
  `TotalSalePrice` double NOT NULL,
  `Adress` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
...
INSERT INTO `sales` VALUES (1,3,299,'nizami kuc',':)',NULL,NULL,0,0);

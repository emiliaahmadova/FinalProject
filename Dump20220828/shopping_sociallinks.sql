...
CREATE TABLE `sociallinks` (
  ...
  `Endpoint` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  ...
  PRIMARY KEY (`Id`),
  KEY `IX_SocialLinks_SettingsId` (`SettingsId`),
  CONSTRAINT `FK_SocialLinks_Settings_SettingsId` FOREIGN KEY (`SettingsId`) REFERENCES `settings` (`Id`) ON DELETE CASCADE
